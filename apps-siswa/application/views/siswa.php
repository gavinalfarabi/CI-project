                 ...
                 <div class="modal-body">
                     <form action="<?= base_url('siswa/edit/' . $ssw->id_siswa) ?>" method="POST">
                         <div class="form-group">
                             ...
                             <input type="text" name="nama_siswa" id="" class="form-control" value="<?= $ssw->nama_siswa ?>">
                             <?= form_error('nama_siswa', '<div class="text-small text-danger">', '</div>'); ?>
                         </div>
                         <div class="form-group">
                             <label for="">Kelas Siswa</label>
                             <input type="text" name="kelas_siswa" id="" class="form-control" value="<?= $ssw->kelas_siswa ?>">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="nomor_telepon" id="" class="form-control" value="<?= $ssw->nomor_telepon ?>">
